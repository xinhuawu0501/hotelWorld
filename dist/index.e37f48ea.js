...
const controlRenderBookmark = (targetHotel)=>{
    (0, _resultViewJsDefault.default)._render(targetHotel);
    _modelJs.state.curId = targetHotel.hotel_id;
    _modelJs.state.curHotel = targetHotel;
};
const init = ()=>{
...
},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","../view/searchView.js":"b2EbH","../view/previewView.js":"fFeKs","../view/resultView.js":"LyN8l","../view/paginationView.js":"0EmXV","../view/navView.js":"3cOBB","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
const API_KEY = "0ea0a61466msh49856b96682cfb0p1b05ddjsn59cffaba105d";
const options = {
    method: "GET",
    headers: {
...
const optionsForGeoCoding = {
    method: "GET",
    headers: {
        "X-RapidAPI-Key": "0ea0a61466msh49856b96682cfb0p1b05ddjsn59cffaba105d",
...
class PreviewView extends (0, _viewJsDefault.default) {
  ...
  `;
    ...
    _generateMarkUp(results) {
        return results ? results.map((data)=>{
            return `
    <li class="preview" id="${data.hotel_id}">
        ...
        }).join("") : `<div class="fallback-message">Oops! No match is found, please try again!</div>`;
    }
    _render(data) {
    ...
    _generateMarkup(data) {
        ...
        <div class="details__gallery">
          <figure class="details__gallery__photo" id="photo-1" >
            <img
          src="${data.allPhotos[0].photo_1280} "
          alt="Main photo"
          srcset="
            ${data.allPhotos[0].photo_1280}      1280w,
            ${data.allPhotos[0].photo_square_60}   60w"
          sizes="(max-width: 430px) 66vw, 800px"
        />
          </figure>
          <figure class="details__gallery__photo" id="photo-2" >
          <img
          src="${data.allPhotos[1].photo_1280} "
          alt="Photo-2"
          srcset="
            ${data.allPhotos[1].photo_1280}      1280w,
            ${data.allPhotos[1].photo_square_60}   60w"
          sizes="(max-width: 430px) 33vw, 333px"
        />
      
          </figure>
          <figure class="details__gallery__photo" id="photo-3" data-open-all="See all ${data.allPhotos.length} photos">
          <img
          src="${data.allPhotos[2].photo_1280} "
          alt="Photo-3"
          srcset="
            ${data.allPhotos[2].photo_1280}      1280w,
            ${data.allPhotos[2].photo_square_60}   60w"
          sizes="(max-width: 430px) 33vw, 333px"
        />
          </figure>
        </div>
      ...
      <div class="details__nearBy details__section">
        ...
        <div class="details__nearBy__items">
      ...
      </div>` : ""}</div>` : `<div class="fallback-message">No location highlights for now :(</div>`}
        </div>
...
},{"./view":"bx4GI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dXNgZ":[function(require,module,exports) {
/**
...
},{}]},["fA0o9","aenu9"], "aenu9", "parcelRequiref439")
