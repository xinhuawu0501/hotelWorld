...
const getGeo = async function(address) {
    try {
        const res = await fetch("https://trueway-geocoding.p.rapidapi.com/Geocode?address=taipei&language=en", (0, _config.optionsForGeoCoding));
...
},{"../js/config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fFeKs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
